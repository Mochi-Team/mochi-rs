...
use mochi_structs::video::{PlaylistEpisodeServerResponse, PlaylistEpisodeServerSubtitle, PlaylistEpisodeServerSubtitleFormat, PlaylistEpisodeServerLink, PlaylistEpisodeServerHeader};
use mochi_imports::{error::Result, http::{Request, RequestMethod}, crypto::Crypto};
...
impl VidCloud {
    pub fn extract(
        ...
        if encrypted {
            ...
            sources = mochi_imports::json::parse(decrypted)?.as_array()?;
        } else {
